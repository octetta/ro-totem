...
- `include/skred/skred_vfs.h`: public virtual-filesystem API included by
  current `api.h` releases;
...
```text
vendor/skred/dist/linux-x86_64/skred-0.42.0-maxed/include/skred/api.h
vendor/skred/dist/linux-x86_64/skred-0.42.0-maxed/lib64/libapi.a
vendor/skred/dist/darwin-arm64/skred-0.42.0-maxed/include/skred/api.h
vendor/skred/dist/darwin-arm64/skred-0.42.0-maxed/lib/libapi.a
```
...
```sh
make pulp-api
make pulp-api PULP_VERSION=0.42.0 PULP_PLATFORM=linux-x86_64
```
...
```sh
make linux SKRED_VERSION=0.42.0
make skred-paths SKRED_VERSION=0.42.0
```
